...
class ExampleController extends Controller
{
    ...
    public function autoGenerateOffer(Request $request){
        try{
            ...
            $shop_name = ['Levis', 'Zara', 'Vijay Sales', 'Fitness', 'Champion'];
            $category_slug = ['men-fashion', 'women-fashion', 'electronics', 'gym', 'sports'];
            ...
            for ($iterator = 0; $iterator < $count; $iterator++){
                ...
                for ($offerType = 1; $offerType <= 4; $offerType++){
                    $category_id = Category::where('slug', $category_slug[$iterator])->pluck('id')->first();
